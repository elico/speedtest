...
update:
	go get -v -u github.com/Bowery/prompt
	go get -v -u github.com/joliv/spark
	go get -v -u github.com/bndr/gotabulate
	go get -v -u github.com/elico/speedtest/speedtestdotnet
clean:
	echo "cleaning"
	rm ./bin/*
	rmdir ./bin
